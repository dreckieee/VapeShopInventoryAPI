...
namespace VapeShopInventoryAPI.Api.Migrations
{
    ...
    [Migration("20260915005314_AddCapitalTransaction")]
    partial class AddCapitalTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VapeShopInventoryAPI.Api.CapitalTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VapeShopInventoryAPI.Api.Settlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VapeShopInventoryAPI.Api.Settlement", b =>
                {
                    ...
                    b.HasOne("VapeShopInventoryAPI.Api.Sale", null)
                        .WithMany()
                        .HasForeignKey("SaleId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
